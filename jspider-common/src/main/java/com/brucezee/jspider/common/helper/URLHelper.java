...
package com.brucezee.jspider.common.helper;
...
public final class URLHelper implements Serializable {
    ...
    /**
     * Create a URLHelper object from the specified String representation.
     *
     * @param spec String representation of the URLHelper
     *
     * @exception MalformedURLException if the string representation
     *  cannot be parsed successfully
     */
    public URLHelper(String spec) throws MalformedURLException {
    ...
    /**
     * Create a URLHelper object by parsing a string representation relative
     * to a specified context.  Based on logic from JDK 1.3.1's
     * <code>java.net.URL</code>.
     *
     * @param context URLHelper against which the relative representation
     *  is resolved
     * @param spec String representation of the URLHelper (usually relative)
     *
     * @exception MalformedURLException if the string representation
     *  cannot be parsed successfully
     */
    public URLHelper(URLHelper context, String spec) throws MalformedURLException {
        ...
        try {
            ...
            // Is this a ref relative to the context URLHelper?
            ...
            if ((context != null) && ((newProtocol == null) ||
                ...
                // If the context is a hierarchical URLHelper scheme and the spec
    ...
    /**
     * Create a URLHelper object from the specified components.  The default port
     ...
     *  compatible APIs
     */
    public URLHelper(String protocol, String host, String file)
    ...
    /**
     * Create a URLHelper object from the specified components.  Specifying a port
     * number of -1 indicates that the URLHelper should use the default port for
     ...
     *  compatible APIs
     */
    public URLHelper(String protocol, String host, int port, String file)
        throws MalformedURLException {
    ...
    /**
     * The authority part of the URLHelper.
     */
    private String authority = null;


    /**
     * The filename part of the URLHelper.
     */
    private String file = null;


    /**
     * The host name part of the URLHelper.
     */
    private String host = null;


    /**
     * The path part of the URLHelper.
     */
    private String path = null;


    /**
     * The port number part of the URLHelper.
     */
    private int port = -1;


    /**
     * The protocol name part of the URLHelper.
     */
    private String protocol = null;


    /**
     * The query part of the URLHelper.
     */
    private String query = null;


    /**
     * The reference part of the URLHelper.
     */
    private String ref = null;


    /**
     * The user info part of the URLHelper.
     */
     ...
     * only if the argument is not null, and is a <code>URLHelper</code> object
     * that represents the same <code>URLHelper</code> as this object.  Two
     ...
     *
     * @param obj The URLHelper to compare against
     */
    ...
    /**
     * Return the authority part of the URLHelper.
     */
    ...
    /**
     * Return the filename part of the URLHelper.  <strong>NOTE</strong> - For
    ...
    /**
     * Return the host name part of the URLHelper.
     */
    ...
    /**
     * Return the path part of the URLHelper.
     */
    ...
    /**
     * Return the port number part of the URLHelper.
     */
    public int getPort() {
    ...
    /**
     * Return the protocol name part of the URLHelper.
     */
    ...
    /**
     * Return the query part of the URLHelper.
     */
    ...
    /**
     * Return the reference part of the URLHelper.
     */
    ...
    /**
     * Return the user info part of the URLHelper.
     */
        ...
        while (true) {
            ...
            if (index == 0)
                throw new MalformedURLException
                    ("Invalid relative URLHelper reference");
     ...
     * if this <code>URLHelper</code> and the <code>other</code> argument both refer
     * to the same resource.  The two <code>URLs</code> might not both contain
     * the same anchor.
     */
    public boolean sameFile(URLHelper other) {
    ...
    /**
     * Return a string representation of this URLHelper.  This follow the rules in
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("URLHelper[");
        sb.append("authority=");
        sb.append(authority);
        sb.append(", file=");
        sb.append(file);
    ...
    /**
     * Parse the specified portion of the string representation of a URLHelper,
    ...
    public static void main(String[] args) throws Exception {
		URLHelper url1=new URLHelper("http://www.chengdu.gov.cn/AA/cc/1.html");
		URLHelper url2=new URLHelper(url1,"../../bb/2.html?name=111");
